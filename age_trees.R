...
#using phylosig
mammalssigL <- phylosig(mammals.comp$phy, mammals.agedat$logage, method="lambda", test=T)
mammalssigK <- phylosig(mammals.comp$phy, mammals.agedat$logage, method="K", test=T)
